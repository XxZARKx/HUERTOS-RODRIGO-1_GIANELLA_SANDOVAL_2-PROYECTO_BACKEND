window.addEventListener('load', function () {
    ...
    function findBy(id) {
          ...
          .then(data => {
              ...
              document.querySelector('#paciente_id').value = pelicula.paciente.nombre;
              document.querySelector('#odontologo_id').value = pelicula.odontologo.nombre;
              document.querySelector('#fecha').value = pelicula.fecha;
